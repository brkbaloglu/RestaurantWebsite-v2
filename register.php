...
if(isset($_POST['submit'])){
   ...
   if($select_user->rowCount() > 0){
      $message[] = 'E-mail veya numara kullanılmakta!';
   }else{
      if($pass != $cpass){
...
<section class="form-container">
   ...
   <form action="" method="post">
      ...
      <input type="password" name="cpass" required placeholder="Şifreyi doğrulayınız" class="box" maxlength="50" oninput="this.value = this.value.replace(/\s/g, '')">
      <div class="cont" style="display: flex; align-items: flex-end; justify-content: space-between;">
