...
<section class="placed-orders">
   ...
   <h1 class="heading">Bekleyen Siparişler</h1>
   ...
   <div class="box">
      ...
      <p> Fiyat : <span>$<?= $fetch_orders['total_price']; ?>/-</span> </p>
      <p> Ödeme Metodu : <span><?= $fetch_orders['method']; ?></span> </p>
      <form action="" method="POST">
         ...
         <div class="flex-btn">
            ...
            <a href="placed_orders.php?delete=<?= $fetch_orders['id']; ?>" class="delete-btn" onclick="return confirm('delete this order?');">Sil</a>
         </div>
      </form>
   </div>
   <?php
      ...
      echo '<p class="empty">Bekleyen sipariş yok!</p>';
   }
   ?>
