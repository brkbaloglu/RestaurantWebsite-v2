...
<div class="heading">
   <h3>Ödeme</h3>
   <p><a href="home.php">Ana Sayfa</a> <span> / Ödeme</span></p>
</div>
...
<form action="" method="post">
   ...
   <div class="cart-items">
      <h3>Sipariş ettiğiniz ürünler</h3>
      <?php
         $grand_total = 0;
         $cart_items[] = '';
      ...
      <?php
            ...
            echo '<p class="empty">Alışveriş sepetiniz boş!</p>';
         }
      ?>
      <p class="grand-total"><span class="name">Toplam :</span><span class="price">$<?= $grand_total; ?></span></p>
      <a href="cart.php" class="btn">Alışveriş sepeti</a>
   </div>
   ...
   <div class="user-info">
      ...
      <a href="update_address.php" class="btn">Adresi güncelle</a>
      <select name="method" class="box" required>
         <option value="" disabled selected>Ödeme yolu seçiniz --</option>
         <option value="cash on delivery">Kapıda ödeme</option>
         <option value="credit card">Kredi kartı</option>
         <option value="paypal">Paypal</option>
      </select>
      <input type="submit" value="Sipariş ver" class="btn <?php if($fetch_profile['address'] == ''){echo 'disabled';} ?>" style="width:100%; background:var(--red); color:var(--white);" name="submit">
   </div>
