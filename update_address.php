...
<section class="form-container">
   ...
   <form action="" method="post">
      <h3>Adresiniz</h3>
      <input type="text" class="box" placeholder="Kat no." required maxlength="50" name="flat">
      ...
      <input type="text" class="box" placeholder="İlçe adı" required maxlength="50" name="town">
      <input type="text" class="box" placeholder="Şehir adı" required maxlength="50" name="city">
      <input type="text" class="box" placeholder="Bölge adı" required maxlength="50" name="state">
      <input type="text" class="box" placeholder="Ülke adı" required maxlength="50" name="country">
      <input type="number" class="box" placeholder="Pin kodu" required max="999999" min="0" maxlength="6" name="pin_code">
